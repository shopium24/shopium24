            ...
            <?php foreach ($response as $id => $data) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <div><b>Место на SSD диске:</b> <?= CMS::filesize($data['quota']['disc'] * 1024 * 1024); ?>
                        </div>
                        <div><b>inode</b> <?= number_format($data['quota']['inode'], 0, '.', ','); ?></div>
                        <div>
                            <b>Сайтов</b> <?= ($data['quota']['sites'] != 999) ? $data['quota']['sites'] : 'неограниченно'; ?>
                        </div>
